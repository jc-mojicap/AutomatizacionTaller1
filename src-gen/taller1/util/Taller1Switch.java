 ...
 * @generated
 */
public class Taller1Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Taller1Package.NOOR_APP: {
			NoorApp noorApp = (NoorApp) theEObject;
			T result = caseNoorApp(noorApp);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Noor App</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Noor App</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNoorApp(NoorApp object) {
		return null;
	}
